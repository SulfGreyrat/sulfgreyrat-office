...
[Установка](#установка) · [Команда агентов](#команда-агентов) · [Как пользоваться](#как-пользоваться) · [Как это устроено](#как-это-устроено)
...
- **Оркестратор** — напишите основному агенту (в Desktop или в Telegram): «разбей и раздай
  по команде: …». Он создаст карточки для нужных ролей.
